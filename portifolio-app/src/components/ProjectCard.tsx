...
interface ProjectCardProps {
  ...
  skills: string[];
  technologies: string[];
  direction?: "left" | "right"; // direção da animação
}
...
export default function ProjectCard({
  ...
  return (
    ...
    className="bg-gray-900 border border-purple-500/50 p-6 rounded-2xl shadow-lg hover:shadow-purple-500/30 hover:scale-105 transition-all"   
    >
